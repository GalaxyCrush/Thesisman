...
public class EntregaDTO {
  ...
  public EntregaDTO(Long id, Long tese, String nomeAluno, String data, byte[] ficheiro, String fileName,
      String estadoTese, String nota) {
    this.id = id;
    this.teseId = tese;
    this.data = data;
  ...
  public void setEstadoTese(String estadoTese) {
    this.estadoTese = estadoTese;
  }
